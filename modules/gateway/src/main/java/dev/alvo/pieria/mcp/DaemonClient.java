...
public class DaemonClient {
  ...
  private static final Logger LOGGER = LoggerFactory.getLogger(DaemonClient.class);
  ...
  private String exchange(Callable<String> call) {
    try {
      ...
      LOGGER.debug("daemon unreachable at {}", baseUrl, e);
      throw new DaemonUnavailableException(baseUrl);
    } catch (Exception e) {
      LOGGER.debug("daemon call failed", e);
      throw new DaemonUnavailableException(baseUrl);
    }
  }
}
