 ...
 * {@code PostToolUse}/{@code PostToolUseFailure}/{@code PreCompact}/{@code Stop}/{@code SessionEnd}
 * hooks in {@code settings.json}, and the {@code /pieria-remember} slash command in
...
public final class ClaudeCodeInstaller implements HarnessInstaller {
   ...
   * with prior memories; PostToolUse and PostToolUseFailure spool tool calls locally;
   * PreCompact/Stop/SessionEnd capture the transcript and ship whatever those hooks spooled.
   */
  private static final Map<String, String> HOOK_EVENTS = new LinkedHashMap<>() {{
    ...
    put("PostToolUseFailure", "post-tool-use");
