 ...
 * {@link OpenAiModelGateway} (built from Spring AI's autoconfigured OpenAI-compatible beans) and the
 * bound {@link PieriaProperties} can be handed to {@link BenchmarkRunner}.
 *
 ...
 *
 * <p>To point at a different provider (e.g. a hosted OpenAI baseline for comparison),
 * override the relevant {@code spring.ai.*} / {@code pieria.provider.*} properties via standard Spring
